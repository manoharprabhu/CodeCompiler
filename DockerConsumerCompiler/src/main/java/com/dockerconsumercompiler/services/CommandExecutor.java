...
public class CommandExecutor {
	...
	public boolean isGccInstalled() throws ExecuteException, IOException {
	...
	public boolean compileCProgramAndGenerateBinary(String queueId, String programName) {
		CommandLine compiler = CommandLine.parse("gcc -x c " + queueId + File.separator + programName + " -o "+ queueId + File.separator + "a.out");
		try {
